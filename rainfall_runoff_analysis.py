...
def analyze_basin(basin_id, data_path):
    """
    Perform complete statistical analysis for one basin.
    ...
    basin_id : str
        Basin identifier
    data_path : str
        Path to the CSV file containing basin data
    ...
    # Check data validity
    if len(prcp) != 3650 or len(runoff) != 3650:
        print(f"Warning: Basin {basin_id} does not have 3650 timesteps")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 2:
        print("Usage: python rainfall_runoff_analysis.py <basin_index>")
        sys.exit(1)
    ...
    data_dir = "/icebox/data/shares/mh2/mosavat/Lumped/data/processed/temporal_test/timeseries"
    output_dir = "/icebox/data/shares/mh2/mosavat/Lumped/results/temp"
